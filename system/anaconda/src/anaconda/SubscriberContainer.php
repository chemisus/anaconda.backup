...
/**
 * {@link \anaconda\SubscriberContainer}
 * 
 * @package     anaconda
 ...
 * @since       0.1
 */
class SubscriberContainer implements \SubscriberComposite {
    ...
    /*\                             Public Methods                           \*/
    /*\**********************************************************************\*/
    public function addSubscriberInterface($value) {
        if (!interface_exists($value)) {
            throw new Exception("Interface or Class name {$value} does not exist.");
        }
        
        $this->interfaces[] = $value;
    }
    
    public function removeSubscriberInterface($value) {
    ...
    public function addSubscriber($value) {
        foreach ($this->interfaces as $interface) {
            if (!($value instanceof $interface)) {
                throw new Exception("Subscriber must implement {$interface}.");
            }
        }
    ...
    public function removeSubscriber($value) {
        $key = array_search($value, $this->subscribers, true);
